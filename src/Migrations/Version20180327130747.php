 ...
 */
class Version20180327130747 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE partie ADD secret_j1_id INT DEFAULT NULL, ADD secret_j2_id INT DEFAULT NULL, ADD dissimulation_j1_id INT DEFAULT NULL, ADD dissimulation_j2_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE partie DROP secret_j1_id, DROP secret_j2_id, DROP dissimulation_j1_id, DROP dissimulation_j2_id');
    }
}
